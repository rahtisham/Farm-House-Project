...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=Nunito" rel="stylesheet">
      ...
      <!--plugins-->
    <link href="{{ asset('admin_ltd/plugins/vectormap/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet"/>
    ...
    <link href="{{ asset('admin_ltd/css/style.css') }}" rel="stylesheet" />
    <link href="{{ asset('admin_ltd/css/icons.css') }}" rel="stylesheet">
...
<body>
  ...
  <div class="wrapper">
    ...
    <!-- Bootstrap bundle JS -->
    <script src="{{ asset('admin_ltd/js/bootstrap.bundle.min.js') }}"></script>
    <!--plugins-->
    <script src="{{ asset('admin_ltd/js/jquery.min.js') }}"></script>
    <script src="{{ asset('admin_ltd/plugins/simplebar/js/simplebar.min.js') }}"></script>
